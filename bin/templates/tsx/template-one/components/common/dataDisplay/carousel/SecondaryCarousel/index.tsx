...
const SecondaryCarousel: React.FC<CarouselProps> = ({ slides }) => {
  ...
  return (
    <>
      <div
        className={`relative sm:w-[290px] md:w-[360px] lg:w-[520px] xl:w-[700px]  mx-auto overflow-hidden rounded-2xl  ${isDragging ? 'cursor-grabbing' : 'cursor-grab'}`}
          ...
          {slides.map((image, index) => (
            <div key={index} className="flex-shrink-0 w-full px-2">
              <img
                ...
                style={{ width: '100%', height: 'auto' }} // Fixed size
